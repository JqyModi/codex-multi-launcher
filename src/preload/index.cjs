...
const api = {
  ...
  startSubscriptionAuthorization: (input) => ipcRenderer.invoke("subscription-auth:start", input),
  pollSubscriptionAuthorization: (sessionId) => ipcRenderer.invoke("subscription-auth:poll", sessionId),
