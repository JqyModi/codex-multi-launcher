...
This folder contains platform-ready launch drafts for Codex 多开助手. Use these files as the source of truth when filling platform editors.
...
- Do not publish directly without a final user confirmation.
