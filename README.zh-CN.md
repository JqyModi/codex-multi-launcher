...
首页集中展示公告、环境提醒、运行中的窗口和版本更新提示：

![Codex 多开助手首页](user-manual-assets/01-dashboard.png)

创建配置时可以分别设置 App 位置、启动器目录、模型服务、接口地址、模型和本地加密保存的 API Key：

![创建独立 Codex 配置](user-manual-assets/02-create-profile.png)
